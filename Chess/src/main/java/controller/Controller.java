...
public class Controller {
  ...
  public Controller(MainRootPane view) {
  ...
  public void setModel(Model model) {
    //carry over settings model to new model
    model.setSettingsModel(this.model.getSettingsModel());
    this.model = model;
